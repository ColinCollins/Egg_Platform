...
{
    public class LegacyGetStartedEditorWindow : EditorWindow
    {
        public static void ShowWindow ()
        {
            LegacyGetStartedEditorWindow window = 
                (LegacyGetStartedEditorWindow)GetWindow(typeof(LegacyGetStartedEditorWindow));
            window.Show();
        ...
        private void CreateDependencies ()
        {
            ...
            OutputDataCollection outputDataCollection = Resources.Load<OutputDataCollection>($"Melenitas Dev/Sounds Good/Outputs/OutputCollection");
            if (outputDataCollection == null)
            {
                Debug.Log("Output Collection was not found. A new one has been created at the following path:\n" + path);
                outputDataCollection = CreateInstance<OutputDataCollection>();
                AssetDatabase.CreateAsset(outputDataCollection, $"{path}/OutputCollection.asset");
                EditorUtility.SetDirty(outputDataCollection);
                allRight = false;
            }
