...
{
    public class LegacyAudioCreatorEditorWindow : EditorWindow
    {
        ...
        // [MenuItem("Tools/Melenitas Dev/Sounds Good/Legacy/Audio Creator", false, 100)]
        static void ShowWindow ()
        {
            // Get existing open window or if none, make a new one:
            LegacyAudioCreatorEditorWindow window = (LegacyAudioCreatorEditorWindow)GetWindow(typeof(LegacyAudioCreatorEditorWindow));
            window.Show();
        ...
        private void CreatorFields ()
        {
            ...
            if (GUILayout.Button(buttonTitle, GUILayout.Height(30)))
            {
                ...
                EditorHelper.ChangeAudioClipImportSettings(validAudioClips.ToArray(), 
